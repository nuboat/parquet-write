...
public class UserRank extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"UserRank\",\"namespace\":\"com.hydrogen18.examples\",\"fields\":[{\"name\":\"userId\",\"type\":\"int\"},{\"name\":\"rank\",\"type\":\"int\"}]}");
   ...
   */
  public static UserRank.Builder newBuilder() {
    return new UserRank.Builder();
  }
   ...
   * @return A new UserRank RecordBuilder
   */
  public static UserRank.Builder newBuilder(UserRank.Builder other) {
    return new UserRank.Builder(other);
  }
   ...
   * @return A new UserRank RecordBuilder
   */
  public static UserRank.Builder newBuilder(UserRank other) {
    return new UserRank.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<UserRank>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(UserRank.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(UserRank other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public UserRank.Builder setUserId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserRank.Builder clearUserId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserRank.Builder setRank(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public UserRank.Builder clearRank() {
